...
export default function Navbar() {
  return (
    <div className={styles.containerNavbar}>
        ...
        <label htmlFor="logo"><img src={burger} alt="Burger" className={styles.burger}/></label>
            ...
            <div className={styles.sidebar}>
              <nav>
                <div>
                  ...
                  <p>En esta sección encontrarás todos las mascotas reportados como perdidos</p>
                </div>
                <div>
                  <img src={lupa} alt="Icono de lupa" />
                  <button>Encontrados</button>
                  <p>En esta sección encontrarás todas las mascotas reportadas como encontradas</p>
                </div>
                <div>
                  <img src={refugio} alt="icono de refugio" />
                  <button>Fundaciones</button>
                  <p>En esta sección encontrarás fundaciones que podras filtrar por zonas</p>
                </div>
                <div>
                  <img src={informacion} alt="icono de informacion" />
                  <button>Información</button>
                  <p>En esta sección encontrarás toda la información necesaria para utilizar esta pagina y mas</p>
                </div>
              </nav>
              <label htmlFor="logo" className={styles.btnClose}>x</label>
            </div>
        </div>
    </div>
  )
